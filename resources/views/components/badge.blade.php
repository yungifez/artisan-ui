@props(['label' => '', 'color' => 'text-[var(--primary-accent-text-color)] dark:text-[var(--dark-primary-accent-text-color)] bg-[color:var(--primary-accent-color)] dark:bg-[color:var(--dark-primary-accent-color)]', 'class' => ''])
