...
"text-sm flex items-center ring-offset-background disabled:cursor-not-allowed
disabled:opacity-50 border",

"bg-background h-10 px-3 justify-left py-2 file:border-0 file:bg-transparent file:text-sm file:font-medium
