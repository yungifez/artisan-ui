<div data-slot="command-dialog" x-data="dialog(false, true)" x-modelable="open" x-bind="root"
    {{$attributes->except('x-teleport')}} @isset($group) {{$group->attributes}} @endisset>
    @isset($trigger)
    ...
    <template x-teleport="{{$attributes->get('x-teleport')}}">
        ...
        <div class="fixed min-h-[100vh] inset-0 z-50 bg-black/80" x-bind="overlay" role="presentation">
            <div role="dialog" x-bind="dialog" class="fixed left-[50%] top-[50%] z-50
