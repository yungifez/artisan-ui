<div data-slot="switch" data-state="{{$attributes->get('checked') ? 'checked' : 'unchecked'}}" x-data="switchInput({{$attributes->has('disabled') ? 'true' : 'false'}})" x-bind="root" role="switch"
