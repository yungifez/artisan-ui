...
<div {{$attributes->class(["relative flex cursor-default gap-2 select-none items-center rounded-sm px-2 py-1.5 text-sm
    ...
    role="option" x-bind="commandItem" data-disabled="@json($disabled)">
    {{$slot}}
</div>
